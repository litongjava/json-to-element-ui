export default {
  ...
  "idType":"long",
  "tableAlias": "Course",
  "pageUri": '/api/table/page',
  "getUri": '/api/table/get',
  "createUri": '/api/table/create',
  "updateUri": '/api/table/update',
  "deleteUri": '/api/table/delete',
  "exportExcelUri": '/api/table/export-excel',
  "exportTableExcelUri": '/api/table/export-table-excel',
  "query": {
    "show": true,
    "items": [
      {
